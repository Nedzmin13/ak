        ...
        <div className="bg-gray-800 text-white text-sm py-2 px-4 sm:px-6 lg:px-8">
            <div className="container mx-auto flex justify-center items-center">
                <div className="flex items-center space-x-4 md:space-x-6">
                    <a href="mailto:info@edilidiamelkaknjo.it" className="flex items-center hover:text-brand-orange transition-colors">
                        <FiMail className="mr-2" />
                        <span className="hidden sm:inline">info@edilidiamelkaknjo.it</span>
                    </a>
